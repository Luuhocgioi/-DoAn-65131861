...
namespace QuanLyGara.Controllers
{
    public class NhanViensController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,HoTen,SoDienThoai,ChucVu")] NhanVien nhanVien)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,HoTen,SoDienThoai,ChucVu")] NhanVien nhanVien)
        {
            if (id != nhanVien.Id)
            {
                return NotFound();
